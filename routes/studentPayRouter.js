...
const { studentPaymentDetails, retrieveStudentDetails, schoolPaymentStatus,  searchStudentByRegistrationNumber, generateVirtualAccount, makePayment, getStudentPaymentDetails, webhook, fidelityWebhook, generateReceiptDetails, getReceipt } = require('../controllers/studentPmtController')
...
router.route('/payment-receipt/:accountNumber').get(getReceipt).all(methodNotAllowed)
